...
import "./SampleBEP20Token.sol";

contract SampleBEP20TokenSale{
    // the admin address isn't kept public, we don't wanna expose it 
    address payable admin;
    SampleBEP20Token public tokenContract;
    uint public tokenPrice;
    uint public tokensSold;

    event Sell( address _buyer, uint _amount);

    constructor(SampleBEP20Token _tokenContract, uint _tokenPrice) public{
        // assign an admin
